        ...
        <div class="main-body">
            <div class="page-wrapper">
                ...
                <div class="page-body">
                    ...
                    <!-- --------------------- -->
                    <?php $product=DB::table('product')->where('id_user',$item->id)->orderby('id','desc')->get(); ?>
                    <div class="page-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <!-- Zero config.table start -->
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <strong><h3 class="m-b-10">รายการสินค้าที่ลงทะเบียน</h3></strong>


                                        <a style="color:white;" class="btn btn-warning" href="{{url('/backend/user')}}">
                                            <i class="fa fa-arrow-left"></i> Back</a>
                                        <a style="color:white;" class="btn btn-success"
                                            href="{{url('/backend/product_add/'.$item->id)}}"> <i class="fa fa-plus"></i> Add</a>
                                            ...
                                            <table id="simpletable2" class="table table-striped table-bordered nowrap">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!-- <td>{{$items->updated_at}}</td> -->
                                                        <td>
                                                            <a href="{{url('/backend/product_edit/'.$items->id)}}"
                                                                class="btn btn-sm btn-primary" style="color:white;"><i
                                                                    class="fa fa-gear"></i>Edit</a>
                                                            <a href="{{url('/backend/product_destroy/'.$items->id)}}"
                                                                class="btn btn-sm btn-danger"
                                                                onclick="javascript:return confirm('You Want To Delete?')"
                                                                style="color:white;"><i
                                                                    class="fa fa-trash"></i>Delete</a>
