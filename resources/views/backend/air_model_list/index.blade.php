                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                      ...
                                      <form action="{{url('backend/air_model_list_excel')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <a style="color:white;" class="btn btn-success" href="{{url('/backend/air_model_list_add')}}">
                                        ...
                                        <table id="simpletable" class="table table-striped table-bordered nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('/backend/air_model_list_edit/'.$items->id)}}"
                                                            class="btn btn-sm btn-primary" style="color:white;"><i
                                                                class="fa fa-gear"></i>Edit</a>
                                                        <a href="{{url('/backend/air_model_list_destroy/'.$items->id)}}"
