            ...
            <div class="page-wrapper">
                ...
                <div class="page-header card">
                    <div class="card-block">
                        <h5 class="m-b-10">Item Point BACKEND</h5>
                    </div>
                </div>
                <!-- Page-header end -->
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a style="color:white;" class="btn btn-success" href="{{url('/backend/item_point_add')}}">
                                        ...
                                        <table id="simpletable" class="table table-striped table-bordered nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('/backend/item_point_edit/'.$items->id)}}"
                                                            class="btn btn-sm btn-primary" style="color:white;"><i
                                                                class="fa fa-gear"></i>Edit</a>
                                                        <a href="{{url('/backend/item_point_destroy/'.$items->id)}}"
