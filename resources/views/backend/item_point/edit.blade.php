            ...
            <div class="page-wrapper">
                ...
                <div class="page-header card">
                    <div class="card-block atm">
                        <h5 class="m-b-10">Item Point/EDIT</h5>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <form method="post" id="" action="{{ url('/backend/item_point_update/'.$item->id) }}"
                                        ...
                                        <br>
                                        <div><a href="{{asset('$item->picture')}}" target="_blank">
                                                <img src="{{asset('$item->picture')}}" width="400px"
                                                    id="imgA"></a></div>
                                        @else
                                        <br>
