                                            ...
                                            <form method="post" id=""
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="datetime-local" name="datetime"
                                                            class="form-control" id="datetime" required=""
                                                            value="{{$detail->date_time}}">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        ...
                                                        <select class="form-control" name="province" id="province"
                                                            ...
                                                            <option value="{{$province->id}}" @if($province->id ==
                                                                $detail->province) selected @endif
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        ...
                                                        <select class="form-control" name="amphure" id="amphure"
                                                            ...
                                                            <option value="{{$amphure->id}}" @if($amphure->id ==
                                                                $detail->amphure) selected @endif>{{$amphure->name_th}}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <p class="text-right">
                                                    <a href="{{ url('/backend/training') }}" style="color:white;"
                                                        class="btn btn-success"> <i class="fa fa-share-square-o"></i>
                                                        Back </a>
