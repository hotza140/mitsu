        ...
        <div class="main-body">
            <div class="page-wrapper">
                ...
                <div class="page-header card">
                    ...
                    <strong> <h5 class="m-b-10">PRODUCT/ADD</h5></strong>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <form method="post" id="" action="{{ url('/backend/product_store') }}"
                                        ...
                                        <br><div><a href="{{asset('$item->picture')}}" target="_blank">
                                        <img src="{{asset('$item->picture')}}" width="400px" id="imgA"></a></div>
                                        @else
                                        ...
                                        <p class="text-right">
                                            <a href="{{ url('/backend/user_edit/'.$id) }}"
