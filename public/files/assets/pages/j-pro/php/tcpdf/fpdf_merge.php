    ...
    class FPDF_Merge{
        ...
        private function _toStream($item){
            switch($item[0]){
                ...
                case self::product_detailERIC     : return $this->_strval($item[1]);
        ...
        private function _addObj($dico = null, $buf = null){
    		...
    		if (is_array($dico)){
                if ($buf !== null){
                    ...
                    $dico['/Length'] = array(self::product_detailERIC, strlen($buf));
                }
        ...
        public function output($filename = null){
            ...
            $ptDico = array(
                ...
                array(
                    ...
                    '/Count'    => array(self::product_detailERIC, count($kids))
                )
            );
            ...
            // Ajout du trailer
            $dico = array(
                '/Size' => array(self::product_detailERIC, 1+count($this->xref)),
